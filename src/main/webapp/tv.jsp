         ...
         <nav class="navbar navbar-expand-lg navbar-light bg-light">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
               <ul class="navbar-nav mr-auto">
                  ...
                  <li class="nav-item">
                     <a class="nav-link" href="tv.jsp">TV</a>
                  </li>
                  <li class="nav-item">
                     <a class="nav-link" href="celebs.jsp">Celebs</a>
                  </li>
               </ul>
               <div class="search_icon"><a href="#"><span class="padding_left_15">Register</span></a></div>
               <div class="search_icon"><a href="#"><span class="padding_left_15">login</span></a></div>
